    ...
    if len(chat_template)<5:
        ...
        if 'quit' in prompt:
            ...
            if response.status_code == 200:
                ...
                "xi-api-key": "76c2fb91437cb5417a9d657b70052fb5"
                }
        ...
        prompt1="give me the feedback of my interview conversation only give positive points"
        user_input = prompt1
        chat_template.append({"role": "user", "content": user_input})
        ...
        prompt2="give me the feedback of my interview conversation analyze give my negative points"
        user_input = prompt2
        chat_template.append({"role": "user", "content": user_input})
        ...
        prompt3="give me the feedback of my interview conversation analyze give me rating and one line review on my interview performance"
        user_input = prompt3
        chat_template.append({"role": "user", "content": user_input})
